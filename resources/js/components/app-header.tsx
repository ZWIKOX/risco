...
import { BookOpen, Folder, LayoutGrid, LucideHome, Menu, Plus, Search } from 'lucide-react';
    ...
    <>
      <div className="border-sidebar-border/80 border-b">
        <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
          {/* Mobile Menu: visible only on small devices */}
            ...
            <Sheet>
              ...
              >
                ...
                <div className="mt-6 flex h-full flex-1 flex-col space-y-4">
                  {/* Only agent navigation items are rendered in the mobile sidebar */}
                  <div className="flex flex-col space-y-4">
                    {agentNavItems.map((item) => (
                      <Link
                        key={item.title}
                        href={item.url}
                        className="flex items-center space-x-2 font-medium p-2 hover:bg-accent hover:text-accent-foreground rounded-md bg-transparent"
                      >
          ...
          {/* Desktop Navigation: visible only on large devices */}
